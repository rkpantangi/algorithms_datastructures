...
public class DiameterOfBinaryTree {
	...
	public static void main(String[] args) {
		...
		TreeNode<Integer> n4 = n2.left(new TreeNode<>(4));
		TreeNode<Integer> n5 = n2.right(new TreeNode<>(5));
		
		TreeNode<Integer> n6 = n4.left(new TreeNode<>(6));
		TreeNode<Integer> n7 = n4.right(new TreeNode<>(7));
		
		TreeNode<Integer> n8 = n5.left(new TreeNode<>(8));
		TreeNode<Integer> n9 = n5.right(new TreeNode<>(9));
		
		TreeNode<Integer> n10 = n6.left(new TreeNode<>(10));
		TreeNode<Integer> n11 = n7.right(new TreeNode<>(11));
		
		TreeNode<Integer> n12 = n9.left(new TreeNode<>(12));
		TreeNode<Integer> n13 = n12.right(new TreeNode<>(13));
